...
const connect = () => {
    ...
    if (!pName.match(/^[a-zA-Z0-9]*$/) || pName == '') return;
    socket.emit('joinedRandom', { pName });
};
...
socket.on('notValid', (msg) => { alert('Username already exists'); pname.value = '' });
